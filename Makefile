...
testacs4:
	python3 test_IMDN_AS.py --test_hr_folder Test_Datasets/Set5/HR --test_lr_folder Test_Datasets/Set5/LR/ --output_folder results/ACS4Set5/ --checkpoint checkpoints/acs4_e1000_40.pth --acs 4
	python3 test_IMDN_AS.py --test_hr_folder Test_Datasets/Set14/HR/ --test_lr_folder Test_Datasets/Set14/LR/ --output_folder results/ACS4Set14/ --checkpoint checkpoints/acs4_e1000_40.pth --acs 4
	python3 test_IMDN_AS.py --test_hr_folder Test_Datasets/BSD100/HR/ --test_lr_folder Test_Datasets/BSD100/LR/ --output_folder results/ACS4BSD100/ --checkpoint checkpoints/acs4_e1000_40.pth --acs 4
	python3 test_IMDN_AS.py --test_hr_folder Test_Datasets/Urban100/HR/ --test_lr_folder Test_Datasets/Urban100/LR/ --output_folder results/ACS4Urban100/ --checkpoint checkpoints/acs4_e1000_40.pth --acs 4
